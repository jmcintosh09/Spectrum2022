...
<?php include ($headerpath);?>
	...
	<div id="page_content" class="page-content no-title-container arrow-bottom " role="main">
		...
		<div class="content_row breadcrumbs">
			...
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Case Study 6 Teacher Note</li>
			  </ol>
			</nav>
		...
		<div class="content_row row">
			...
			<div class="col">
				<h2 class="section-header text-center">Case Study 6</h2>
				<h3 class="section-header text-center">Defiant Student</h3>
				...
				<div class=" justify-content-center information ">
					<div class="buttons row">
						<a href="case-study-6-answer.php" class="btn btn-au-odark col">Back</a>
						<a href="case-study-7.php" class="btn btn-au-bdark col">Next Case Study</a>
					</div>
				</div>
			</div>
