	...
	<div class="site-header" role="banner" aria-label="Site header">
		...
		<div class="row align-items-center">
			...
			<div class="col-9 col-md-4 image header-logo">
				<a href="<?=$headerimage_destination;?>">
				<img src="<?=$headerimage_url;?>" class="d-print-none" alt="<?=$headerimage_alt;?>"> 
				<img src="<?=$headerimage_print;?>" alt="<?=$headerimage_print_alt;?>" class="d-none d-print-block" style="width:500px;">	
				</a>
			</div>
