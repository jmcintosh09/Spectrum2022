...
<?php include ($headerpath);?>
	...
	<div id="page_content" class="page-content no-title-container arrow-bottom " role="main">
		...
		<div class="content_row row">
			...
			<div class="col">
				<h2 class="section-header text-center">Case Study 4</h2>
				...
				<div class=" justify-content-center information ">
					<div class="buttons row">
						<a href="case-study-4-answer.php" class="btn btn-au-odark col">Back</a>
						<a href="case-study-5.php" class="btn btn-au-bdark col">Next Case Study</a>
					</div>
				</div>
			</div>
